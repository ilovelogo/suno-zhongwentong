...
const VIBE_DICTIONARY = [
  ...
  { en: 'brisk gentle fingerpicking', zh: '轻快温和的手指拨弦，不是拿片扫' },
  ...
  // 演奏技法与律动模式
  { en: 'tight four-on-the-floor groove', zh: '紧凑利落的鼓声一下一下跟着手拍打，每一拍都有一声' },
  { en: 'driving four-on-the-floor groove', zh: '推进有力的鼓声一下一下跟着手拍打，每一拍都有一声' },
  { en: 'four-on-the-floor groove', zh: '鼓声一下一下跟着手拍打，每一拍都有一声' },
  { en: 'four-on-the-floor', zh: '鼓声一下一下跟着手拍打，每一拍都有一声' },
  ...
  { en: 'fingerpicked and lightly strummed steel-string guitar', zh: '细腻手指拨弦与轻柔扫弦的钢弦吉他' },
  ...
  { en: 'warm fingerpicking', zh: '温暖质感的手指拨弦' },
  ...
  { en: 'clap', zh: '击掌拍手声' },
  { en: 'snap', zh: '清脆响指' },
  { en: 'fingerpicking guitar', zh: '用手指拨弦的吉他，不是拿片扫' },
  { en: 'fingerpicking', zh: '用手指拨弦，不是拿片扫' },
  { en: 'fingerstyle', zh: '用手指拨弦，不是拿片扫' },
  ...
  translateMusicDescription(text) {
    ...
    for (const seg of segments) {
      ...
      if (!matchedZh) {
        ...
        // 规则 29 & 138：中文行严禁保留英文单词碎片
        if (!/[a-zA-Z]/.test(res)) {
          matchedZh = res;
        }
      }

      if (matchedZh && !/[a-zA-Z]/.test(matchedZh)) {
        validZhSegments.push(matchedZh);
      }
    }

    if (validZhSegments.length === 0) return '';

    const localResult = validZhSegments.join(' · ');
