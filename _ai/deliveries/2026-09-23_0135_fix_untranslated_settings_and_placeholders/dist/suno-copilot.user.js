...
class SunoCopilotEngine {
  ...
  scanNavigationAndMenus() {
    const candidates = document.querySelectorAll(
      'a, button, [role="button"], nav span, aside span, header span, div[role="tab"], summary, [class*="trigger"], [class*="accordion"], h2, h3, h4, label, [class*="label"], [class*="title"], [class*="setting"], [class*="control"], [class*="option"]'
    );
    ...
    for (const el of candidates) {
      ...
      const wrapper = el.parentElement ? el.parentElement.closest('a, button, [role="button"], label, summary, [class*="trigger"], [class*="setting"]') : null;
