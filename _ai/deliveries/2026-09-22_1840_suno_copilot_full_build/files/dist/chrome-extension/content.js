...
(function () {
  ...
  },
  {
    ...
    "prompt_tag": "Separate Vocals & Music",
    "expert_status": "draft",
    "expert_notes": ""
  },
  {
  ...
  },
  {
    ...
    "prompt_tag": "Exclude: drums, autotune",
    "expert_status": "draft",
    "expert_notes": ""
  },
  {
    ...
    "prompt_tag": "Creativity / Temperature",
    "expert_status": "draft",
    "expert_notes": ""
  },
  {
  ...
  },
  {
    ...
    "category": "vocals_performance",
    "zh_name": "怒音 / 真声高亢爆发",
    "tier1_vernacular": "像实力派歌手在大型体育场高潮时的全力嘶吼大爆发！用充满力量感的真声直冲高音，情绪浓烈到极点（类似 Adele、华晨宇或摇滚主唱）。",
    "tier2_suno_usage": "适合写在 [Chorus] 最终大高潮或高音顶点歌词前，指示 Suno 释放最饱满的人声能量。",
    "tier3_example": "[Chorus]\n[Belting: Powerful emotional high notes]\n我绝不向风暴低头！！！",
    "prompt_tag": "[Belting: Powerful high notes]",
    "expert_status": "draft",
    "expert_notes": ""
  },
  {
  ...
  },
  {
    ...
    "tier3_example": "melodic techno, afterlife style, dark atmospheric synths, hypnotic bass, cinematic buildup",
  ...
  },
  {
    ...
    "tier3_example": "epic cinematic orchestral, hans zimmer style, soaring brass, thunderous war drums, heroic climax",
...
class SunoCopilotEngine {
  ...
  if (typeof window !== 'undefined') {
    window.sunoCopilotInstance = new SunoCopilotEngine(SUNO_GLOSSARY, '');
  }
})();
